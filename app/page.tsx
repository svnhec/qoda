...
import { TerminalTyper } from "@/components/landing/terminal-typer";
import { AnimatedCounter } from "@/components/landing/animated-counter";
import { LiveTransactionFeed } from "@/components/landing/live-transaction-feed";
      ...
      >
        ...
        <motion.div className="relative mt-16 md:mt-24 w-full max-w-5xl" variants={itemVariants}>
          ...
          <div
            ...
            style={{
              background: "radial-gradient(ellipse at center, oklch(0.8 0.2 155 / 0.15) 0%, transparent 60%)",
              filter: "blur(60px)",
            }}
          />
