...
import { LayoutDashboard, Users, Bot, Activity, FileText, Bell, CreditCard, Settings, Wallet } from "lucide-react";
          ...
          return (
            <motion.div key={item.href} variants={itemVariants}>
              ...
              >
                ...
                <span className="text-[9px] mt-1 uppercase tracking-wider">{item.label}</span>
                {isActive && (
                  <motion.div
